...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->error_messages = \Lang::file('juploader', \Config::get('application.language'), 'errors');
        if (count($this->error_messages)==0) $this->error_messages = \Lang::file('juploader', 'en', 'errors');
